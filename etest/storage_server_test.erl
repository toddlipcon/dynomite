...
couch_storage_test() ->
  ...
  {ok, State} = couch_storage:open("testdata/couch", storage_test),
...
%   {ok, State} = fs_storage:open("testdata/storage_test", storage_test),
...
%   
% fs_storage_test() ->
%   {ok, Pid} = storage_server:start_link(fs_storage, "testdata/storage_test", store2, 0, (2 bsl 31)),
